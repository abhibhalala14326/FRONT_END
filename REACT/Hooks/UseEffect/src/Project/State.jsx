...
const Chnage_state = () => {
    ...
    const [Nextslider , setNextslider] = useState(false)
    const [Prevslider, setPrevslider] = useState(false);
                          ...
                          >
                            <div className="flex justify-between gap-8 my-2 ">
                              <button
                                className="btn"
                                onClick={prevState}
                                disabled={Nextslider ? true : false}
                              >
                                Previous
                              </button>
                              <div className="flex gap-3 ">
                                <input
                                  ...
                                  id=""
                                  value={theam}
                                  onChange={changeTheam}
                                  className="border border-green-900 p-2"
                                />
                                <button className="btn" onClick={changeIndex}>
                                  click
                                </button>
                              </div>
                              <button
                            ...
                            <div className={` flex justify-left mt-10`}>
                              {List.map((item) => {
                                return (
                                  <div
                                    className={` max-w-sm bg-white  rounded-lg shadow dark:bg-transparent  dark:border-gray-700 ${cardSlide}`}
                                    key={item.id}
                                  >
                                    <div
                                      className={`${
                                        Nextslider ? "animate-slide" : ""
                                      }  ${
                                        Prevslider ? "animate-prevSlider" : ""
                                      }  `}
                                    >
                                      <a href="#">
                                        <img
                                      ...
                                      <div className="p-5">
                                        ...
                                        <div
                                          className={`${btn}  mb-3 font-normal text-gray-300 dark:text-gray-300 text-left leading-8 `}
                                        >
