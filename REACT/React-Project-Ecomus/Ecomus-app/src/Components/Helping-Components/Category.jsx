  ...
  return (
    <div className="w-full flex overflow-hidden rounded-3xl h-auto px-4 sm:px-0">
      <div className="w-full relative flex justify-center items-center overflow-hidden duration-1000 rounded-3xl">
        ...
        />
        {/* Text Overlay */}
        <div className="absolute top-7 left-7 sm:left-5">
        ...
        {/* Button */}
        <button className="absolute sm:bottom-4 bottom-5 group bg-white flex items-center gap-2 duration-500 font-bold hover:bg-black hover:text-white justify-center sm:px-4 sm:py-3 px-3 py-2 border-black border rounded-[40px] left-7 sm:left-5">
          Shop Now
          <FiArrowUpRight className="hidden text-2xl group-hover:block " />
        </button>
      </div>
    </div>
  );
