...
const ProductSlider = ({ items }) => {
  ...
  return (
    <div className="container m-auto px-5 overflow-hidden">
      <Slider {...settings}>
        {items.map((item) => {
            ...
            >
              <div className="w-full h-full overflow-hidden relative group/card lg:w-full">
                ...
                <img
                  ...
                  className="w-[95%] h-full group-hover/card:opacity-0 bg-black hover:scale-105 object-cover duration-1000"
                />
